...
public abstract class ModernBaseMessageContextMenu implements IMessageContextMenu {
     ...
     */
    public ModernBaseMessageContextMenu(JDA jda, IBotMeta meta) {
     ...
     * delegating to {@link #execute(MessageContextInteractionEvent)}.
     *
    ...
    private boolean checkOwnerOnly(MessageContextInteractionEvent event, CommandReplyConfig replyConfig) {
    ...
    private boolean checkDMOnly(MessageContextInteractionEvent event, CommandReplyConfig replyConfig) {
    ...
    private boolean checkPrivateChannelOnly(MessageContextInteractionEvent event, CommandReplyConfig replyConfig) {
    ...
    private boolean checkGuildOnly(MessageContextInteractionEvent event, CommandReplyConfig replyConfig) {
    ...
    private boolean checkUserPermissions(MessageContextInteractionEvent event, CommandReplyConfig replyConfig) {
    ...
    private boolean checkBotPermissions(MessageContextInteractionEvent event, CommandReplyConfig replyConfig) {
    ...
    private void applyDeferIfNeeded(MessageContextInteractionEvent event) {
        if (getClass().isAnnotationPresent(DeferReply.class)) {
            event.deferReply().queue();
        }
    }

    private void logDebug(MessageContextInteractionEvent event) {
